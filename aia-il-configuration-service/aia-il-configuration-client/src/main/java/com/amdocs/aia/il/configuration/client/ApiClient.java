package com.amdocs.aia.il.configuration.client;
...
import com.amdocs.aia.il.configuration.client.auth.*;
import com.amdocs.aia.il.configuration.client.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
  ...
  private String basePath = "http://localhost/aia/api/v1/integration-layer";

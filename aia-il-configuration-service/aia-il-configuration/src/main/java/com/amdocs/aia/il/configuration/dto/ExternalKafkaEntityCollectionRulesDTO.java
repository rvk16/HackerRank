...
/**
 * ExternalKafkaEntityCollectionRulesDTO
 */
@Validated


public class ExternalKafkaEntityCollectionRulesDTO extends ExternalEntityCollectionRulesDTO  {
  ...
  public String toString() {
    ...
    sb.append("class ExternalKafkaEntityCollectionRulesDTO {\n");

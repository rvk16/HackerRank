...
import com.amdocs.aia.il.configuration.api.CachedEntityTransformationApiController;
...
@WebMvcTest(value = CachedEntityTransformationApiController.class, excludeAutoConfiguration = SecurityAutoConfiguration.class)
public class CachedEntityTransformationApiControllerUnitTest extends AbstractApiControllerUnitTest {
    private static final String BASE_PATH = "/aia/api/v1/integration-layer/projects/aia/configuration/cached-entity-transformation";

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private CachedEntityTransformationService service;

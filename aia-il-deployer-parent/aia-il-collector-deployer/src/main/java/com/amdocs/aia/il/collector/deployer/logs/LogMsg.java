package com.amdocs.aia.il.collector.deployer.logs;


import com.amdocs.aia.il.collector.deployer.constants.ConfigurationConstants;
...
public class LogMsg {
    ...
    private void init() {
        ...
        try {
            bundle = ResourceBundle.getBundle(ConfigurationConstants.RESOURCE_BUNDLE_PATH, defaultLocale);
            appBundle = ResourceBundle.getBundle(ConfigurationConstants.APPLICATION_BUNDLE_NAME, defaultLocale);

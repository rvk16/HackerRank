...
public class InMemoryCacheBulkRandomAccessTable implements RandomAccessTable {
    ...
    public InMemoryCacheBulkRandomAccessTable(ConfigurationRow configurationRow) {
    ...
    public Collection<RepeatedMessage> queryData(String mainTable, Collection<KeyColumn> rowsToQuery) throws Exception {
    ...
    @Override
    public List<RelationKeyInfo> queryListChildDataWithBulkProcessedFlag(String mainTable, Collection<KeyColumn> rowKeys,
                                                                         String contextName, String relType, String relationTable,
                                                                         Long batchProcessingTimestamp) {
        return new ArrayList<>();
    }
